...
export class ProductsComponent implements OnInit {
  ...
  public productoSeleccionado: Products = {
    product_id: 0,
    name: '',
    description: '',
    img_url: '',
  ...
  openCard(id: number): void {
    this.productoSeleccionado = this.products.find(p => p.product_id === id)!;
  }

  closeCard(): void {
    this.productoSeleccionado = { product_id: 0, name: '', category_id: 0, price: 0, description: '', img_url: '', opcionesSeleccionadas: [] };
  }
